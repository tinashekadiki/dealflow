...
export const environment: any = {
  ...
  // https://asgard.qubedlab.com/dealer-management-service-v1.0.2/generalsettings/managers/organisation/branch/{{organisationId}}/{{branchId}}
  get fetchManagers(): string{
    return `${this.dmsBaseUrl}generalsettings/managers/organisation/branch`;
  },
